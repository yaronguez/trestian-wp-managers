 ...
 */
// plugin
if ( class_exists( 'Trestian_Loader_V1012', false ) ) {
	return;
}
 ...
 */
$priority = 9993;
$trestian_loader = new Trestian_Loader_V1013(__FILE__);
add_action( 'muplugins_loaded', array($trestian_loader, 'load'), $priority );
